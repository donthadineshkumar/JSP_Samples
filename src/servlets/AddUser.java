...
/**
 Класс Adduser, расширяющий класс Dispatcher, добавляет нового пользователя. Этот сервлет инициализирует экземпляр объекта User
 и присваивает значения, полученные из запроса пользователя, его свойствам. Если такой пользователь уже присутствует
 в списке пользователей UserList, вызывается Страница errorRegistration.html,
